...
import bg from "@/app/assets/images/registration-bg.jpg";
const Contact = () => {
  return (
    <section className="py-16 relative">
      ...
      <div className="container mx-auto px-4">
        <div className="grid grid-cols-1 md:grid-cols-2 gap-10">
          ...
          <div className="bg-white dark:bg-gray-800 dark:text-gray-100 rounded-2xl px-8 py-10 lg:max-w-5xl  shadow-md shadow-gray-600 mx-auto">
