    ...
    <div className="rounded-lg shadow-md dark:bg-gray-900">
      ...
      <div className="p-4 flex flex-col justify-between">
        ...
        <p className="text-sm text-gray-500 py-2">
          One of the best selling {product.category} in the market by .
        </p>
        <div className="flex justify-between gap-4 mt-2">
          <div>
            ...
            <span className="text-slate-500 text-sm mr-2 line-through">
              Rs.{product.price}
            </span>
          </div>
          <button
            ...
            className=" text-red-700 rounded px-2 py-1 text-sm flex items-center gap-2"
          >
            <FaShoppingCart />
          </button>
        </div>
...
const PopularProducts = () => {
  ...
  useEffect(() => {
    const fetchProduct = async () => {
      const response = await getproducts({ category: "smartphone" });
  ...
  return (
    <section
      id="popular-products"
      className="py-16 bg-white dark:bg-gray-800 dark:text-white"
    >
